                                ...
                                <div class="row">
                                    <div class="col-md-12 fv-row fv-plugins-icon-container ">
                                        <div class="mb-5 fv-row">
                                            <label class="required form-label">{{ __('admin.global.attribute_value_name') }}</label>
                                            <input type="text" name="name_ar" class="form-control mb-2 w-100"
                                                placeholder="{{ __('admin.global.attribute_value_name') }}"
                                                value="{{ isset($attribute_value) ? optional($attribute_value)->translate('ar')->name ?? '' : '' }}" />
                                        </div>
                                    </div>
                                </div>
                                <div>
                                    <label class="form-label">{{ __('admin.global.attribute_value_description') }} </label>
                                    <textarea name="description_ar" id="summernote1">{{ isset($attribute_value) ? optional($attribute_value)->translate('ar')->description ?? '' : '' }}</textarea>
                                </div>
                            </div>
                                    ...
                                    <div class="col-md-12 fv-row fv-plugins-icon-container ">
                                        <div class="mb-5 fv-row">
                                            ...
                                            <input type="text" name="name_en" id="name_en" class="form-control mb-2"
                                                placeholder="{{ __('admin.global.attribute_value_name') }}"
                                                value="{{ isset($attribute_value) ? optional($attribute_value)->translate('en')->name ?? '' : '' }}" />
                                        </div>
                                    </div>
                                </div>
                                <div>
                                    <label class="form-label">{{ __('admin.global.attribute_value_description') }}</label>
                                    <textarea name="description_en" id="summernote1_en">{{ isset($attribute_value) ? optional($attribute_value)->translate('en')->description ?? '' : '' }}</textarea>
                                </div>
                            </div> 
                        </div>
                    </div>
                            ...
                            <div class="formContent">
                                <div class="row g-9 mb-7">
                                    <div class=" fv-row fv-plugins-icon-container">
                                        ...
                                        <input class="form-control form-control-solid"  placeholder="{{ __('admin.global.price') }}" name="price" value="{{ isset($attribute_value) ? $attribute_value->price:'' }}">
                                    </div>
                                     
                                    <div class=" fv-row fv-plugins-icon-container">
                                        <label class="required fs-6 fw-semibold mb-2">{{ __('admin.form.duration') }}</label>
                                        <input class="form-control form-control-solid" placeholder="{{ __('admin.form.duration') }}" name="duration" value="{{ isset($attribute_value) ? $attribute_value->duration:'' }}">
                                    </div>
                                    ...
                                    <div class=" fv-row fv-plugins-icon-container">
                                        ...
                                        <input type="text" class="form-control form-control-solid" placeholder="انسخ عنوان الفيديو من الفيمو وألصقه هنا" value="{{ isset($attribute_value) ? $attribute_value->introduction_video:'' }}" name="introduction_video" >
                                    </div>
                                </div>
                            </div>
                        </div>
