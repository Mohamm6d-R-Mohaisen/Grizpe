...
@section('content')
    <form id="kt_form" class="form row d-flex flex-column flex-lg-row addForm" data-kt-redirect="{{ route('admin.blogs.index') }}"
        ...
        <div class="page-content-header d-flex" style="justify-content: end;">
            <div class="mr-5 ml-5">
                <a href="{{ route('admin.blogs.index') }}" id="kt_ecommerce_add_product_cancel" class="btn btn-outline btn-outline-dashed me-2 mb-2 cancel px-18">
...
@push('scripts')
    ...
    <!-- Form Repeater & Draggable Initialization -->
