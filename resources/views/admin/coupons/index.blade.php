                    ...
                    {{-- <div class="page-content-header">
                        <div class="row justify-content-between">
                            <div class="col-3 col-sm-12 col-md-3 col-lg-3">
                                <h2 class="table-title">{{ __('admin.global.coupons') }}</h2>
...
@push('scripts')
    <script>
        window.datatable_url = "{{ route('admin.coupons.datatable') }}";
    </script>
    <script src="{{ asset('admin_assets/plugins/custom/datatables/datatables.bundle.js') }}"></script>
    <script src="{{ asset('admin_assets/js_resources/coupons.js?v=' . $java_version) }}"></script>
