<div class="tableActions">
    <a class="btn" href="{{route('admin.coupons.edit', ['coupon' => $instance->id])}}">
        <span class="svg-icon">
    ...
    <a class="svg-icon" data-kt-docs-table-filter="delete_row" data-action="{{route('admin.coupons.destroy', ['coupon'=> $instance->id])}}">
        <svg data-kt-docs-table-filter="delete_row" data-action="{{route('admin.coupons.destroy', ['coupon'=> $instance->id])}}" xmlns="http://www.w3.org/2000/svg"
