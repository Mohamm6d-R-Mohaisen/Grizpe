...
<div class="content d-flex flex-column flex-column-fluid customerView mb-5" id="kt_content">
    <div class="row g-5">
        <div class="col-xl-6">
            ...
            <div class="card card-flush overflow-hidden h-lg-100">
                ...
                <div class="card-header pt-5">
                    ...
                    <h3 class="card-title align-items-start flex-column">
                        <span class="card-label fw-bold text-dark">مخطط</span>
                        <span class="text-gray-400 mt-1 fw-semibold fs-6">قياس </span>
                    </h3>
                    <!--end::Title-->
                    <!--begin::Toolbar-->
...
@push('scripts')
    <script>
        let temp_data = [65, 50, 80, 60, 60, 45, 45, 80, 80, 70, 70, 90, 90, 80, 80, 80, 60, 60, 50];
    </script>
