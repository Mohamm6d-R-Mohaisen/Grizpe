<div class="tableActions">
    <a class="btn" href="{{route('admin.home_sections.edit', ['home_section' => $instance->id])}}">
        <span class="svg-icon">
    ...
    <a class="svg-icon" data-kt-docs-table-filter="delete_row" data-action="{{route('admin.home_sections.destroy', ['home_section'=> $instance->id])}}">
        <svg data-kt-docs-table-filter="delete_row" data-action="{{route('admin.home_sections.destroy', ['home_section'=> $instance->id])}}" xmlns="http://www.w3.org/2000/svg"
