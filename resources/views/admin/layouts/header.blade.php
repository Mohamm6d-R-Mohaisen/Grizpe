                ...
                <div class="ms-3" id="languge">
                    ...
                    <a rel="alternate" hreflang="en"
                        ...
                        <div class="symbol symbol-circle symbol-25px">
                            <img src="{{asset('admin_assets/media/flags/united-states.svg')}}" class="img-fluid" alt="en" />
                        </div>
                    </a>
                    @else
                    <a rel="alternate" hreflang="ar"
                        ...
                        class="btn btn-icon btn-sm btn-active-color-primary mt-n2">
                        <div class="symbol symbol-circle symbol-25px">
                            <img src="{{asset('admin_assets/media/flags/saudi-arabia.svg')}}" class="img-fluid" alt="ar" />
                        </div>
                    </a>
                    @endif
                </div>
