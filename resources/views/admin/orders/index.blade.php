                    ...
                    <div class="page-content-header">
                        <div class="row justify-content-between">
                            <div class="col-3 col-sm-12 col-md-3 col-lg-3">
                                <h2 class="table-title">{{ __('admin.global.orders') }}</h2>
                                    ...
                                    <table class="table align-middle table-row-dashed fs-6 gy-5 dataTable no-footer"
                                        ...
                                        <thead>
                                            ...
                                            <tr class="text-start text-gray-400 fw-bold fs-7 text-uppercase gs-0 text-center">
                                                <th>#</th>
                                                <th>{{ __('admin.global.user') }}</th>
                                                <th>{{ __('admin.global.total') }}</th>
...
@push('scripts')
    ...
    <script src="{{ asset('admin_assets/js_resources/orders.js?v=' . $java_version) }}"></script>
