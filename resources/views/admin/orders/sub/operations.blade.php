<div class="tableActions">
    <a class="btn" href="{{route('admin.orders.show', ['order' => $instance->id])}}">
        <span class="svg-icon">
    ...
    {{-- <a class="btn p-0" href="{{route('admin.orders.edit', ['order' => $instance->id])}}">
        <span class="svg-icon">
            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20">
                <g id="Group_55532" data-name="Group 55532" transform="translate(0 -4)">
                    <g id="Iconly_Light-outline_Edit_Square" data-name="Iconly/Light-outline/Edit Square" transform="translate(0 4)">
    ...
    <a class="svg-icon" data-kt-docs-table-filter="delete_row" data-action="{{route('admin.orders.destroy', ['order'=> $instance->id])}}">
        <svg data-kt-docs-table-filter="delete_row" data-action="{{route('admin.orders.destroy', ['order'=> $instance->id])}}" data-name="{{ $instance->name }}" xmlns="http://www.w3.org/2000/svg"
