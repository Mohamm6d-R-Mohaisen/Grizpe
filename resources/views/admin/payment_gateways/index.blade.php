...
@section('title')
    {{ __('admin.global.payment_gateways') }}
@endsection
@section('content')
                    ...
                    <div class="page-content-header">
                        <div class="row justify-content-between">
                            <div class="col-3 col-sm-12 col-md-3 col-lg-3">
                                <h2 class="table-title">{{ __('admin.global.payment_gateways') }}</h2>

                            </div>
                            <div class="col-8 col-sm-12 col-md-9 col-lg-9">
                                <div class="card-toolbar flex-row-fluid d-flex justify-content-end gap-5">
                                    <!--Add new user start-->
                                    <a class="btn btn-primary" href="{{ route('admin.payment_gateways.create') }}">
...
@push('scripts')
    <script>
        window.datatable_url = "{{ route('admin.payment_gateways.datatable') }}";
    </script>
    <script src="{{ asset('admin_assets/plugins/custom/datatables/datatables.bundle.js') }}"></script>
    <script src="{{ asset('admin_assets/js_resources/payment_gateways.js?v=' . $java_version) }}"></script>
