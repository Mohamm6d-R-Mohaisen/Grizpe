<div class="tableActions">
    <a class="btn" href="{{route('admin.payment_gateways.edit', ['payment_gateway' => $instance->id])}}">
        <span class="svg-icon">
    ...
    <a class="svg-icon" data-kt-docs-table-filter="delete_row" data-action="{{route('admin.payment_gateways.destroy', ['payment_gateway'=> $instance->id])}}">
        <svg data-kt-docs-table-filter="delete_row" data-action="{{route('admin.payment_gateways.destroy', ['payment_gateway'=> $instance->id])}}" xmlns="http://www.w3.org/2000/svg"
