                        ...
                        <div class="row justify-content-between">
                            ...
                            <div class="col-8 col-sm-12 col-md-9 col-lg-9">
                                <div class="card-toolbar flex-row-fluid d-flex justify-content-end gap-5">
                                    <!--Add new user start-->
                                    <a class="btn btn-primary" href="{{ route('admin.planes.create') }}">
...
@push('scripts')
    <script>
        window.datatable_url =
            "{{ route('admin.planes.datatable') }}";
    </script>
    <script src="{{ asset('admin_assets/plugins/custom/datatables/datatables.bundle.js') }}"></script>
    <script src="{{ asset('admin_assets/js_resources/plans.js?v=' . $java_version) }}"></script>
