                    ...
                    <div class="card card-flush">
                        <div class="card-header mt-5">
                            <div class="card-toolbar my-1">
                                ...
                                <div class="me-6 my-1">
                                    <select id="kt_filter_category" data-control="select2" data-hide-search="true" class="w-125px form-select form-select-solid form-select-sm">
                                        <option value="all" selected="selected">اسم التصنيف</option>
                                    ...
                                    <table class="table align-middle table-row-dashed fs-6 gy-5 dataTable no-footer"
                                        ...
                                        <thead>
                                            <tr class="text-start text-gray-400 fw-bold fs-7 text-uppercase gs-0 text-center">
                                                <th>#</th>
                                                <th>{{ __('admin.global.product_name') }}</th>
                                                <th>{{ __('admin.global.categories') }}</th>
...
@push('scripts')
    ...
    <script src="{{ asset('admin_assets/js_resources/products.js?v=' . $java_version) }}"></script>
