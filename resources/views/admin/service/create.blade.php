    ...
    <form id="kt_form" class="form row d-flex flex-column flex-lg-row addForm" data-kt-redirect="{{ route('admin.services.index') }}"
        ...
        <div class="d-flex flex-column gap-5 col-lg-3 mb-7 ">
                    ...
                    <div class="card-toolbar">
                        <label class="form-check form-switch form-check-custom form-check-solid">
                            ...
                            <input class="form-check-input btn active_operation" style="margin: 0 auto;" type="checkbox"
                                name="status" @if(isset($service) && $service->status == 'active') checked="checked" @endif value="1" >
            ...
            <div class="card-toolbar">
                ...
                <input class="form-control" type="text" id="icon" name="icon" placeholder="fa-solid fa-user"
                ...
                <div class="card-header card-header justify-content-center p-5">
                    <div class="card-toolbar">
                        <div class="image-input image-input-outline image-input-placeholder image-input-empty" data-kt-image-input="true">
                            ...
                            <div class="image-input-wrapper w-200px h-200px" style="background-image: url(@if(isset($service) && $service->image !== null) {{ asset($service->image) }} @else {{ asset('admin_assets/media/svg/avatars/blank.svg') }} @endif)"></div>
                                    ...
                                    <div class="col-md-12 fv-row fv-plugins-icon-container ">
                                        <div class="mb-5 fv-row">
                                            ...
                                            <input type="text" name="title_ar" class="form-control mb-2 w-100"
                                                ...
                                                value="{{ isset($service) ? $service->translate('ar')->title : '' }}" />
                                        </div>
                                    </div>
                                </div>
                                <div>
                                    <label class="form-label">{{ __('admin.global.category_description') }} </label>
                                    <textarea name="description_ar"class="form-control" >{{ isset($service) ? $service->translate('ar')->description : '' }}</textarea>
                                </div>
                                <div>
                                    <label class="form-label">{{ __('admin.global.category_description') }} </label>
                                    <textarea class="form-control"  name="short_description_ar" ">{{ isset($service) ? $service->translate('ar')->short_description : '' }}</textarea>
                                </div>
                            </div>
                                    ...
                                    <div class="col-md-12 fv-row fv-plugins-icon-container ">
                                        <div class="mb-5 fv-row">
                                            ...
                                            <input type="text" name="title_en" id="title_en" class="form-control mb-2"
                                                placeholder="{{ __('admin.global.category_name') }}"
                                                value="{{ isset($service) ? $service->translate('en')->title : '' }}" />
                                        </div>
                                    </div>
                                </div>
                                <div>
                                    <label class="form-label">{{ __('admin.global.category_description') }}</label>
                                    <textarea name="description_en" class="form-control">{{ isset($service) ? $service->translate('en')->description : '' }}</textarea>
                                </div>
                                <div>
                                    <label class="form-label">{{ __('admin.global.category_description') }}</label>
                                    <textarea class="form-control" name="short_description_en" >{{ isset($service) ? $service->translate('en')->short_description : '' }}</textarea>
                                </div>
                            </div>
                        </div>
                    </div>
