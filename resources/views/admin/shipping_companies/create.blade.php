@extends('admin.layouts.master', ['is_active_parent' => 'shipping_companies','is_active'=> 'shipping_companies'])
@section('title')
    {{ __('admin.global.add_new_shipping_company') }}
@endsection
@section('content')
    <form id="kt_form" class="form row" data-kt-redirect="{{ route('admin.shipping_companies.index') }}"
            action="{{ isset($shipping_company) ? route('admin.shipping_companies.update' ,  $shipping_company->id) : route('admin.shipping_companies.store') }}">
        @csrf
        ...
        <div class="page-content-header">
            <h2 class="table-title">{{ __('admin.global.add_new_shipping_company') }}</h2>
        </div>
                    ...
                    <div class="card-toolbar">
                        <label class="form-check form-switch form-check-custom form-check-solid">
                            ...
                            <input class="form-check-input btn active_operation" style="margin: 0 auto;" type="checkbox"
                                name="status" @if(isset($shipping_company) && $shipping_company->status == 1) checked="checked" @endif value="1" >
                                    ...
                                    <div class="col-md-12 fv-row fv-plugins-icon-container ">
                                        <div class="mb-5 fv-row">
                                            ...
                                            <input type="text" name="name_ar" class="form-control mb-2 w-100"
                                                placeholder="{{ __('admin.global.name') }}"
                                                value="{{ isset($shipping_company) ? optional($shipping_company)->translate('ar')->name ?? '' : '' }}" />
                                        </div>
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <div class="col-md-12 fv-row fv-plugins-icon-container ">
                                        <div class="mb-5 fv-row">
                                            ...
                                            <input type="text" name="name_en" id="name_en" class="form-control mb-2"
                                                placeholder="{{ __('admin.global.name') }}"
                                                value="{{ isset($shipping_company) ? optional($shipping_company)->translate('en')->name ?? '' : '' }}" />
                                        </div>
                                    </div>
                                </div>
                            </div> 
                    ...
                    <div class="card-body pt-0">
                        <div class="mt-5">
                            <div class="row">
                                <div class="col-md-12 fv-row fv-plugins-icon-container ">
                                    <div class="mb-5 fv-row">
                                        <label class="required form-label">{{ __('admin.global.cost') }}</label>
                                        <input type="text" name="cost" class="form-control mb-2 w-100"
                                            placeholder="{{ __('admin.global.cost') }}"
                                            value="{{ isset($shipping_company) ? $shipping_company->cost:'' }}" />
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-12 fv-row fv-plugins-icon-container ">
                                    <div class="mb-5 fv-row">
                                        <label class="required form-label">{{ __('admin.global.tracking_url') }}</label>
                                        <input type="text" name="tracking_url" class="form-control mb-2 w-100"
                                            placeholder="{{ __('admin.global.tracking_url') }}"
                                            value="{{ isset($shipping_company) ? $shipping_company->tracking_url:'' }}" />
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div class="page-buttuns mt-5">
                    <div class="row justify-content-between">
                        <div class="d-flex justify-content-end right">
                            ...
                            <a href="{{ route('admin.shipping_companies.index') }}" id="kt_ecommerce_add_product_cancel"
