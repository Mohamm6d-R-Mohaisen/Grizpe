<div class="tableActions">
    <a class="btn" href="{{route('admin.shipping_companies.edit', ['shipping_company' => $instance->id])}}">
        <span class="svg-icon">
    ...
    <a class="svg-icon" data-kt-docs-table-filter="delete_row" data-action="{{route('admin.shipping_companies.destroy', ['shipping_company'=> $instance->id])}}">
        <svg data-kt-docs-table-filter="delete_row" data-action="{{route('admin.shipping_companies.destroy', ['shipping_company'=> $instance->id])}}" xmlns="http://www.w3.org/2000/svg"
