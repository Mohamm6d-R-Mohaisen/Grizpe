...
<body>
    <div class="emailContainer">
        ...
        <div class="emailbody">
            ...
            <p class="emailText">{{ __('auth.email.to_verify_your_account') }}</p>
            <p class="emailText">{{ __('auth.email.this_activation_code_from') }}</p>
            {{--        <h1>{{ $data['title'] }} {{ $data['activation_code'] }}</h1> --}}
            {{--        <p>{{ $data['body'] }}</p> --}}
